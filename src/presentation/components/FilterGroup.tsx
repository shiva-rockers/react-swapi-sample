...
const FilterGroup = (props: FilterGroupProps) => {
    return <Group position="center" mb="lg" mt="sm" spacing="md">
        <TextInput
            placeholder={LABELS.SEARCH_PLACEHOLDER}
            value={props.search}
            onChange={props.handleSearchChange}
            size="md"
            rightSection={props.search ? <IconX onClick={props.handleClearSearch} style={{ cursor: 'pointer' }} /> : <IconSearch />}
        ...
        <Select
            ...
            value={props.filter}
            rightSection={props.filter ? <IconX onClick={props.handleClearFilter} style={{ cursor: 'pointer' }} /> : undefined}
        ...
        <Select
            ...
            value={props.sort}
            rightSection={props.sort ? <IconX onClick={props.handleClearSort} style={{ cursor: 'pointer' }} /> : undefined}
